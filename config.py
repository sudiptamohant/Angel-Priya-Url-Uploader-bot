...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("6118812161:AAHCZrTJnGNpIfxGOmzkjGhEP1c5231kYJ0", "")
    ...
    MAX_FILE_SIZE = 999999999999999999
    ...
    LAZY_DEVELOPER = set(int(x) for x in os.environ.get("1375408229", "").split())
